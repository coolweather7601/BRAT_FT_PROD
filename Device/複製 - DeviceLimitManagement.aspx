<%@ Page Language="C#" AutoEventWireup="true" CodeFile="複製 - DeviceLimitManagement.aspx.cs"
...
<body>
    <form id="form1" runat="server">
                                ...
                                <asp:GridView ID="gvLimit" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDevicePool2"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="變更" ShowHeader="False">
                                            ...
                                            <FooterTemplate>
                                                <asp:Button ID="btnInsert" runat="server" CommandName="Insert" Text="Insert" Font-Size="X-Small" />
                                                <asp:Button ID="btnUpdateAll" runat="server" CommandName="UpdateAll" Text="Update" Font-Size="X-Small" />
                                                <asp:CheckBox ID="cbSelAll" runat="server" AutoPostBack="True" OnCheckedChanged="cbSelAll_CheckedChanged" Text="Select All" />
                                                <asp:Button ID="btnOScheck" runat="server" CommandName="OS_Check" />
                                        ...
                                        <asp:TemplateField HeaderText="連絡人" SortExpression="ENGINEER">
                                            <EditItemTemplate>
                                                <asp:DropDownList ID="ddlEngEdit" runat="server" DataSourceID="SqlEngSrc" DataTextField="EMP_NAME"
                                                    DataValueField="EMP_NAME" OnDataBound="ddlEngEdit_DataBound">
                                                </asp:DropDownList><asp:HiddenField ID="hiddEngEdit" runat="server" Value='<%# Eval("ENGINEER") %>' />
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="Label5" runat="server" Text='<%# Bind("ENGINEER") %>'></asp:Label>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                                <asp:DropDownList ID="ddlEngInst" runat="server" DataSourceID="SqlEngSrc" DataTextField="EMP_NAME"
                                                    DataValueField="EMP_NAME" OnDataBound="ddlEngInst_DataBound">
                                                </asp:DropDownList>
                                            </FooterTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="電話" SortExpression="PHONE">
                                            <EditItemTemplate>
                                                <asp:Label ID="labPhoneEdit" runat="server" Height="16px" Text='<%# Eval("PHONE") %>'></asp:Label>
                                                <asp:TextBox ID="txtPhoneEdit" runat="server" Text='<%# Bind("PHONE") %>' Width="79px"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="Label6" runat="server" Text='<%# Bind("PHONE") %>'></asp:Label>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                                <asp:TextBox ID="txtPhoneInst" runat="server" Width="79px"></asp:TextBox>
                                            </FooterTemplate>
                                        </asp:TemplateField>
                                    </Columns>
        ...
        <asp:SqlDataSource ID="SqlDevicePool2" runat="server" ConnectionString="<%$ ConnectionStrings:BRAT_TEST %>"
            ...
            UpdateCommand="UPDATE LIMIT_EXPERTISE SET CRITERION =:CRITERION, PIORITY =:PIORITY, EQUATION =:EQUATION, UNIT =:UNIT, QTY =:QTY, CRITERION2 =:CRITERION2, EQUATION2 =:EQUATION2, UNIT2 =:UNIT2, QTY2 =:QTY2,  ACTION=:ACTION, HOLD_CODE=:HOLD_CODE, COMMENTS=:COMMENTS, ENGINEER=:ENGINEER, PHONE=:PHONE where ID =:ID"

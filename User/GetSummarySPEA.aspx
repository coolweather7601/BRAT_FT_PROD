<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true"
    CodeFile="GetSummarySPEA.aspx.cs" Inherits="GetSummarySPEA" Title="BR@T" %>
            ...
            <ContentTemplate>
                ...
                <asp:GridView ID="gvBatchInfo" runat="server" BackColor="#CCFF99" BorderColor="DodgerBlue"
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="FILE_LOCATION,FILE_NAME" DataNavigateUrlFormatString="http://atoweb1.tw-khh01.nxp.com/cgi-bin/Paperless/SPEA_readRawData.pl/{0}/{1}"

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Limit_Match_Case.aspx.cs" Inherits="User_Limit_Match_Case" %>
        ...
        <asp:GridView ID="gvResult" runat="server" AutoGenerateColumns="False" CellPadding="3" OnRowDataBound="gvResult_RowDataBound" Font-Size="X-Small" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" OnRowCreated="gvResult_RowCreated" CssClass="mGrid">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="連絡人" SortExpression="ENGINEER">
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("ENGINEER") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="Label4" runat="server" Text='<%# Bind("ENGINEER") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>

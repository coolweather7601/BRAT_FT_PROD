<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GetActionLogAGILENT.aspx.cs" Inherits="GetActionLogAGILENT" Title="BR@T" %>
            ...
            <ContentTemplate>
                ...
                <asp:GridView ID="gvBatchInfo" runat="server" BackColor="#CCFF99" BorderColor="DodgerBlue"
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="FILE_LOCATION,FILE_NAME" DataNavigateUrlFormatString="http://klx1001vm.tw-khh01.nxp.com/cgi-bin/Paperless/AGILENT_readRawData.pl/{0}/{1}"
                    ...
                    <table width="650" style="border-right: silver thin solid; border-top: silver thin solid; border-left: silver thin solid; border-bottom: silver thin solid">
                        <tr>
                            <td align="center" colspan="1" rowspan="3" style="vertical-align: middle; text-align: center; border-right: gray 1px solid; border-top: gray 1px solid; border-left: gray 1px solid; border-bottom: gray 1px solid; background-color: #ccff99; width: 30px;"
                                ...
                                結<br />
                                果</td>
                            <td align="center" valign="bottom" rowspan="3" style="border-right: gray 1px solid; border-top: gray 1px solid; border-left: gray 1px solid; border-bottom: gray 1px solid; width: 420px; vertical-align: middle; text-align: center;">
                                <div id="div1" runat="server" style="height: 120px; vertical-align: text-bottom; text-align: center;" >
                                    <br />
                                <asp:Label ID="labBratResult" runat="server" Font-Bold="True" Font-Size="X-Large"></asp:Label></div></td>

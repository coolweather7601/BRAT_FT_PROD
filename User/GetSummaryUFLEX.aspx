<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true"
    CodeFile="GetSummaryUFLEX.aspx.cs" Inherits="GetSummaryUFLEX" Title="BR@T" %>
            ...
            <ContentTemplate>
                ...
                <asp:GridView ID="gvBatchInfo" runat="server" BackColor="#CCFF99" BorderColor="DodgerBlue"
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="FILE_LOCATION,FILE_NAME" DataNavigateUrlFormatString="http://atoweb1.tw-khh01.nxp.com/cgi-bin/Paperless/UFLEX_readRawData.pl/{0}/{1}"
                        ...
                        <tr>
                            ...
                            <td align="center" rowspan="3" style="border-right: gray 1px solid; border-top: gray 1px solid;
                                ...
                                <div id="div1" runat="server" style="height: 100px; vertical-align: text-bottom; text-align: center;" >
                                    <br />
                                    <br />
                                <asp:Label ID="labBratResult" runat="server" Font-Bold="True" Font-Size="XX-Large"></asp:Label></div>
                            </td>

<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true"
    CodeFile="GetSummaryTURBO.aspx.cs" Inherits="GetSummaryTURBO" Title="BR@T" %>
            ...
            <ContentTemplate>
                ...
                <asp:GridView ID="gvBatchInfo" runat="server" BackColor="#CCFF99" BorderColor="DodgerBlue"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="temperature" HeaderText="Temp" />
                    </Columns>
                ...
                <asp:HiddenField ID="hiddStage" runat="server" />
                <asp:HiddenField ID="hiddTemp" runat="server" />

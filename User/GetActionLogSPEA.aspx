<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GetActionLogSPEA.aspx.cs" Inherits="GetActionLogSPEA" Title="BR@T" %>
            ...
            <ContentTemplate>
                ...
                <asp:GridView ID="gvBatchInfo" runat="server" BackColor="#CCFF99" BorderColor="DodgerBlue"
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="FILE_LOCATION,FILE_NAME" DataNavigateUrlFormatString="http://klx1001vm.tw-khh01.nxp.com/cgi-bin/Paperless/SPEA_readRawData.pl/{0}/{1}"

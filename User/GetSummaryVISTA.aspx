<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true"
    CodeFile="GetSummaryVISTA.aspx.cs" Inherits="GetSummaryVISTA" Title="BR@T" %>
            ...
            <ContentTemplate>
                ...
                <asp:GridView ID="gvBatchInfo" runat="server" BackColor="#CCFF99" BorderColor="DodgerBlue"
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="FILE_LOCATION,FILE_NAME" DataNavigateUrlFormatString="http://atoweb1.tw-khh01.nxp.com/cgi-bin/Paperless/VISTA_readRawData.pl/{0}/{1}"
                ...
                <asp:HiddenField ID="hiddStage" runat="server" /><asp:HiddenField ID="hiddSpecStage" runat="server" /><asp:HiddenField ID="hiddDevice" runat="server" />

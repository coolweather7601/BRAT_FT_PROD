<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="DisposalList2.aspx.cs" Inherits="DisposalList2" Title="BR@T" %>
        ...
        <cc1:CalendarExtender ID="calendarButtonExtender2" runat="server" TargetControlID="TXTDateTo" Format="yyyy-MM-dd" PopupButtonID="IMGTo">
            ...
            <asp:GridView ID="GVDisposal2" runat="server" AutoGenerateColumns="False" BackColor="White"
                ...
                <Columns>
                    ...
                    <asp:BoundField  DataField="BATCH" HeaderText="OLD_BR@T">
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemStyle HorizontalAlign="Center" Wrap="False" />
                    </asp:BoundField>
